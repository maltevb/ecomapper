...
if __name__ == "__main__":
    root = '/home/ecomapper/data/datasets/logs/controlnet/' 
    model_names = [
        "Final_controlnet_lora_512_rank_64_skip_loc_and_date_2_epochs_finetune_12_all_1_epoch",
    ]
    for name in model_names:
        image_folder = os.path.join(root, name, '1', '512')
